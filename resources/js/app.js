...
window.Echo.channel('PersonalChat').listen('.chating', (data) => {
    ...
    if (isCurrentUser) {
        ...
        messageHtml = `
            ...
            <div class="msg_cotainer_send">${messageData.message}
            <span class="msg_time_send">${formatMessageTime(messageData.created_at)}</span>
            </div>
            <div class="img_cont_msg sndrMsg-img">
            <img src="${userProfilePath}" class="rounded-circle user_img_msg">
            </div>
            </div>`;
        ...
        messageHtml = `
            ...
            <div class="msg_cotainer">${messageData.message}
            <span class="msg_time">${formatMessageTime(messageData.created_at)}</span>
            </div>
            </div>`;
    }
